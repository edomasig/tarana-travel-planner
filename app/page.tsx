...
export default function HomePage() {
  ...
  const isItinerary = (content: string) => {
    return content.includes('Day 1') || content.includes('Day 2') || content.includes('Budget') || content.includes('₱')
  }
  ...
  const shouldShowAd = (index: number) => {
    return index > 1 && (index + 1) % 4 === 0 && mounted
  }
